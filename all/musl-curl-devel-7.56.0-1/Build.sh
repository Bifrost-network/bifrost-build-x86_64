...
SRCVER=curl-devel-7.56.0
PKG=musl-$SRCVER-1 # with build version

PKGDIR=${PKGDIR:-/var/lib/build/all/$PKG}
SRC=/var/spool/src/curl-7.56.0.tar.bz2
BUILDDIR=/var/tmp/src/curl-7.56.0
DST="/var/tmp/install/$PKG"

#########
# Install dependencies:
pkg_install musl-openssl-1.0.2k-1 || exit 2
...
#########
# Configure
$PKGDIR/B-configure-1 --prefix=/opt/musl --bindir=/usr/bin --with-ca-bundle=/etc/pki/tls/certs/ca-bundle.crt || exit 1
